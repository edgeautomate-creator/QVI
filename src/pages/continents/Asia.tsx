...
export default function Asia() {
  ...
  const trips = [
    {
      id: 'japan',
      title: language === 'es' ? 'El Origen del Sol' : 'The Origin of the Sun',
      location: language === 'es' ? 'Japón' : 'Japan',
      duration: language === 'es' ? '11 días' : '11 days',
      price: '$5,995',
      image: 'https://images.pexels.com/photos/402028/pexels-photo-402028.jpeg?auto=compress&cs=tinysrgb&w=1920',
      link: '/japan-tour',
      description: language === 'es'
        ? 'Descubre la majestuosa combinación de tradición milenaria y modernidad en Japón'
    ...
    },
    {
      ...
      link: '/asia-maldives-tour',
      description: language === 'es'
        ? 'Una aventura única que combina cultura asiática vibrante y playas paradisíacas'
        : 'A unique adventure combining vibrant Asian culture and paradise beaches'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div
        ...
        style={{
          backgroundImage: 'linear-gradient(rgba(26, 43, 92, 0.75), rgba(26, 43, 92, 0.75)), url(https://images.pexels.com/photos/161401/fushimi-inari-taisha-shrine-kyoto-japan-temple-161401.jpeg?auto=compress&cs=tinysrgb&w=1920)',
        }}
      >
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white px-4">
          <nav className="absolute top-8 left-8 flex items-center space-x-2 text-sm">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-[#ff6b6b]">{t('continents.asia')}</span>
          </nav>
          ...
          <p className="text-xl md:text-2xl text-center max-w-3xl">
            {language === 'es'
              ? 'Experimenta la fascinante mezcla de tradición ancestral y modernidad ultramoderna'
              : 'Experience the fascinating blend of ancient tradition and ultra-modern innovation'}
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-16 bg-gradient-to-r from-[#1a2b5c] to-[#243a75] rounded-2xl p-12 text-white text-center">
          <h3 className="text-3xl font-bold mb-4">
            {language === 'es'
              ? '¿Listo para explorar Asia?'
              : 'Ready to explore Asia?'}
          </h3>
          <p className="text-lg mb-8 opacity-90">
            {language === 'es'
              ? 'Contáctenos hoy para obtener más información sobre nuestros viajes a Asia.'
              : 'Contact us today for more information about our trips to Asia.'}
          </p>
