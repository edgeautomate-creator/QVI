  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div
        ...
        style={{
          backgroundImage: 'linear-gradient(rgba(26, 43, 92, 0.75), rgba(26, 43, 92, 0.75)), url(https://images.pexels.com/photos/378570/pexels-photo-378570.jpeg?auto=compress&cs=tinysrgb&w=1920)',
        }}
      >
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white px-4">
          <nav className="absolute top-8 left-8 flex items-center space-x-2 text-sm">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-[#ff6b6b]">{t('continents.america')}</span>
          </nav>
          <h1 className="text-5xl md:text-6xl font-bold mb-4 text-center">
            {t('continents.america')}
          </h1>
          <p className="text-xl md:text-2xl text-center max-w-3xl">
            {language === 'es'
              ? 'Explora la diversidad natural y cultural de América del Norte'
              : 'Explore the natural and cultural diversity of North America'}
          </p>
        </div>
      </div>
